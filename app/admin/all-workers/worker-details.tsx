...
export function WorkerDetails({ user, onBack }: WorkerDetailsProps) {
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Button variant="ghost" size="sm" onClick={onBack} className="text-gray-600 hover:text-black">
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-6 space-y-6">
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-black border-b border-orange-500 pb-2">מידע אישי</h2>

            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                <Label htmlFor="full_name" className="text-right block text-black">
                  שם מלא
                </Label>
                <Input
                  id="full_name"
              ...
              <div className="space-y-2">
                <Label htmlFor="birth_date" className="text-right block text-black">
                  תאריך לידה
                </Label>
                <Input
                  id="birth_date"
          ...
          {/* Salary Information */}
          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-black border-b border-orange-500 pb-2">מידע שכר</h2>

            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                <Label htmlFor="salary_regular" className="text-right block text-black">
                  שכר רגיל (₪)
                </Label>
                <Input
                  id="salary_regular"
                  ...
                  onChange={(e) => handleInputChange("salary_regular", Number(e.target.value))}
                  className="text-right border-gray-200 focus:border-orange-500 focus:ring-orange-500"
                />
              </div>

              <div className="space-y-2">
                <Label htmlFor="salary_manager" className="text-right block text-black">
                  שכר מנהל (₪)
                </Label>
                <Input
                  id="salary_manager"
                  ...
                  onChange={(e) => handleInputChange("salary_manager", Number(e.target.value))}
                  className="text-right border-gray-200 focus:border-orange-500 focus:ring-orange-500"
                />
              </div>
            </div>
          ...
          {/* Bank Information */}
          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-black border-b border-orange-500 pb-2">פרטי בנק</h2>

            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                <Label htmlFor="bank_name" className="text-right block text-black">
                  שם הבנק
                </Label>
                <Input
                  id="bank_name"
              ...
              <div className="space-y-2">
                <Label htmlFor="bank_branch_number" className="text-right block text-black">
                  מספר סניף
                </Label>
                <Input
                  id="bank_branch_number"
                  value={formData.bank_branch_number}
                  onChange={(e) => handleInputChange("bank_branch_number", e.target.value)}
                  className="text-right border-gray-200 focus:border-orange-500 focus:ring-orange-500"
                />
              </div>

              <div className="space-y-2">
                <Label htmlFor="bank_account_number" className="text-right block text-black">
                  מספר חשבון
                </Label>
                <Input
              ...
              <div className="space-y-2">
                <Label htmlFor="form101_pdf_path" className="text-right block text-black">
                  נתיב טופס 101
                </Label>
                <Input
                  id="form101_pdf_path"
                  value={formData.form101_pdf_path}
                  onChange={(e) => handleInputChange("form101_pdf_path", e.target.value)}
                  className="text-right border-gray-200 focus:border-orange-500 focus:ring-orange-500"
                />
              </div>
            </div>
